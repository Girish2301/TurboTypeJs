...
export const TESTIMONIALS = [
  {
    ...
    image: "",
    tweet:
      "TurboTYpe has dramatically improved my typing speed. I've gone from 40 WPM to over 80 WPM in just a month!",
  },
  {
    name: "Michael R.",
    username: "michael_r",
...
export const WS_URL =
  process.env.NEXT_PUBLIC_WS_URL ?? "https://ws.TurboTYpe.club";
